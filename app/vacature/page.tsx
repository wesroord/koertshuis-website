  ...
  return (
    <>
      <style>{`
        ...
        .vac-bar { width:48px; height:4px; background:var(--red); border-radius:2px; margin:0 auto 24px; }
        ...
        .why-card-bar { width:28px; height:3px; background:var(--red); border-radius:2px; margin-bottom:14px; }
      ...
      <section className="why-work">
        <div className="why-inner">
          ...
          <div className="why-grid">
            {[
              { title:"Lokale werkgever", desc:"Wij zijn een gevestigd bedrijf in De Lutte met een sterke naam in de regio Twente." },
              { title:"Afwisselend werk", desc:"Van particuliere installaties tot grote bedrijfsprojecten — elke dag is anders." },
              { title:"Ontwikkeling", desc:"Ruimte voor persoonlijke groei en het bijhouden van vakkennis via trainingen." },
              { title:"Goed team", desc:"Een kleine, hechte organisatie waar iedereen telt en direct meewerkt." },
              { title:"Goede werktijden", desc:"Gestructureerde werktijden met ruimte voor een goede werk-privébalans." },
              { title:"24/7 storingsdienst", desc:"Deelname aan de storingsdienst, met bijbehorende vergoeding en bereikbaarheidstoelage." },
            ].map(w => (
