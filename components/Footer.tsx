      ...
      <footer className="footer">
        <div className="footer-top">
          ...
          <div className="footer-col">
            <h4>Navigatie</h4>
            <ul>
              {[["Home","/"],["Elektrotechniek","/elektrotechniek"],["Projecten","/projecten"],["Storingsdienst","/storingsdienst"],["Winkel","/winkel"],["Contact","/contact"],["Vacature","/vacature"]].map(([l,h]) => (
        ...
        <div className="footer-bottom">
          <div className="footer-bottom-inner">
            ...
            <span>Webdesign: <a href="https://www.conneqtai.nl" target="_blank" rel="noopener noreferrer">ConneqtAI</a></span>
          </div>
        </div>
      </footer>
    </>
